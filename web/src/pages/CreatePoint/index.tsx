...
//Estado de array ou objeto: manualmente informar o tipo da variável
...
const CreatePoint = () =>{
  ...
  const [ufes, setUfes] = useState<string[]>([]);
    ...
    <div id="page-create-point">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          ...
          <Map center={initialPosition} zoom={17.44} onclick={handleMapClick} >
          <TileLayer
